...
export function Main(props) {
    ...
    return (
            <main className="content">
                <Switch>
                    <ProtectedRoute path="/" loginIn={props.isLoginIn} exact>
                    ...
                    <Route path="/sign-up"> 
                        <Register submit={props.submit} status={props.status} setStatus={props.setStatus} changeHeaderLink={props.changeHeaderLink}/>
                    </Route>
                    <Route path="/sign-in">
                        <Login changeLoginStatus={props.changeLoginStatus} submit={props.submit} status={props.status} setStatus={props.setStatus} changeHeaderLink={props.changeHeaderLink}/>
                    </Route>
                </Switch>
            </main>
    )
